<nav class="navbar navbar-expand-lg navbar-light  mb-4 "style="background-color: #B0EDA9;">
		...
		<li class="nav-item">  <a class="nav-link" href="<?php echo URLROOT . 'pages/contact'; ?>">Contact</a>
		 ...
		 <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <?php if (isset($_SESSION['user_id'])) : ?>
              <li><a class="dropdown-item" href="<?php echo URLROOT . 'pages/admin'; ?>">admin panel</a></li>
