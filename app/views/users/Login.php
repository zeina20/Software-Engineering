            ...
            <div class="card d-flex mx-auto my-5">
                <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12 c1 p-5">
                        <div class="row mb-5 m-3"> <!-- <img src="https://i.imgur.com/pFfTOwy.jpg" width="70vw" height="55vh" alt=""> --> </div> <img src="../../public/images/egyeurologo.jpg" width="220vw" height="210vh" class="mx-auto d-flex" alt="LOGO">
                        <div class="row justify-content-center">
                            <div class="w-100 mx-md-5 mx-1 mx-sm-2 mb-5 mt-4 px-sm-5 px-md-2 px-xl-1 px-2">
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12 c2 px-5 pt-5">
                        ...
                        <form onsubmit="event.preventDefault()" name="myform" onsubmit="" class="px-5 pb-5">
                            ...
                            </div> <input type="text" name="email" placeholder="email"> <input type="password" name="password" placeholder="Password"> <button class="text-white text-weight-bold bt">Log in</button>
