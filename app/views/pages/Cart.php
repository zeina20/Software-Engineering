    ...
    public function output()
    {
        ...
        <h1 id="heading1">
            <h2 style="font-weight:bold;">
                <center>Please fill this form!</center>
            </h2>
            <img src="http://localhost/Software-Engineering/public/images/egyeurologo.jpg" alt="Login Logo"
                 style="width:200px; height:200px;">
            <div>
                <form method="post" action="http://localhost/Software-Engineering/public/pages/cart?action=checkout" class="myForm" name="myForm">

                    <div class="input-container d-flex justify-content-center">
                        <span>Total : <?php echo $this->controller->total; ?></span>
                    </div>
